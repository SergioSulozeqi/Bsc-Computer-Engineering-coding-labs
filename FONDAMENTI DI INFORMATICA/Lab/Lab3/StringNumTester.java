...
public class StringNumTester
{
	...
	int first = 3;  // provare varie combinazioni di first e last, in 
        int last = 10;  // particolare esaminare i seguenti casi: 
	                ...
	                // Cosa succede? Perche`? RISPOSTA: nei primi due casi e nel quarto ottengo un errore in esecuzione in quanto i parametri non si
                    // trovano nell'intervallo richiesto per quella stringa. Quando first = last ho una stringa vuota perchè vengono estratti
                    // i caratteri fino a quello che si trova in posizione last-1. 
	...
	first = 5; //provare a cambiare i valori di first e last. Si generano
	last = 11; //errori? Di che tipo? Perche`? RISPOSTA: si generano errori se cambio first e last perchè nella si cercano di trasformare delle
	                                         //caratteri in numeri.
	...
	last = 24; //errori? Di che tipo? Perche`? RISPOSTA: si generano errori se cambio first e last perchè nella si cercano di trasformare delle
	                                         //lettere in numeri.
	...
	//Perche`? Cosa significa l'operatore "+" nei due casi? Perchè nel primo caso si fa una concatenazione di stringhe, mentre nel secondo
	//caso si fa la somma fra 2 numeri.
